...
function Search(){
	...
	useEffect( () => {
		...
		if ( keyword.length > 0 ) {
			fetchProducts (`${fetchUrl}&search=${keyword}`)
		} else {
			fetchProducts (`${fetchUrl}${page}`)
		}
	}, [keyword, page])
						...
						<div className="col-12 col-md-6">
							...
							<form onSubmit={searchProduct} method="GET">
								<div className="form-group">
									{/* <label htmlFor="">Buscar por nombre, descripción, categoría, color</label> */}
									<input type="text" name='product' className="form-control" placeholder="Buscar por nombre, descripción, categoría, color" />
								</div>
